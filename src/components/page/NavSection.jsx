  ...
  return (
    <div className="fixed bottom-9 left-1/2 transform -translate-x-1/2 z-50">
      <Dock iconMagnification={60} iconDistance={100}>
        <DockIcon
          className="bg-black/10 hover:dark:bg-white/10 cursor-pointer"
          onClick={() =>
            window.open("https://github.com/souryeahdeep", "_blank")
          }
        >
        ...
        <DockIcon
          ...
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/souryadeep-ganguly-b46054240/",
              "_blank",
            )
          }
        >
        ...
        <DockIcon
          className="bg-black/10 hover:dark:bg-white/10 cursor-pointer"
          onClick={() => window.open("https://x.com/jealous_caesar", "_blank")}
        >
        ...
        <DockIcon
          className="bg-black/10 hover:dark:bg-white/10 cursor-pointer"
          onClick={() =>
            window.open("https://www.instagram.com/souryeahdeep/", "_blank")
          }
        >
