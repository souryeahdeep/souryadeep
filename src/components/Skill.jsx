    ...
    <section id="skills" className="min-h-screen bg-black text-white flex items-center justify-center p-8">
      <motion.div className="max-w-3xl w-full">
        <motion.h1 className="text-4xl text-red-300 md:text-4xl font-bold mb-16">
          Fine, you wanna know the skills?
        </motion.h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="space-y-6">
            ...
            <motion.div className="text-3xl md:text-3xl font-bold flex items-center gap-3"
                        ...
                        viewport={{ once: true }}>
              MagicUI
              <svg width="32" height="32" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                <rect width="256" height="256" rx="128" fill="url(#paint0_linear_601_4643)"></rect>
                <rect width="256" height="256" rx="128" fill="url(#paint1_linear_601_4643)"></rect>
                ...
                <defs>
                  ...
                  <linearGradient id="paint1_linear_601_4643" x1="78" y1="3.7012e-06" x2="236" y2="256" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#9E7AFF"></stop>
                    <stop offset="0.333333" stop-color="#FE8BBB"></stop>
                    <stop offset="0.666667" stop-color="#FFBD7A"></stop>
                    <stop offset="1" stop-color="#F8EAC3"></stop>
                  </linearGradient>
                </defs>
              </svg>
            </motion.div>
